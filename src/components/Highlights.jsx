    ...
    <section className="bg-black py-20 px-6" id="design">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-8 mb-16">
          <div className="bg-gray-900 rounded-3xl p-8 hover:scale-105 transition-all duration-300">
            <img
        ...
        <div
          className="bg-gray-900 rounded-3xl p-12 mb-16 py-20 px-6"
          id="performance"
        >
        ...
        <div id="camera" className="text-center py-20 px-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900 rounded-2xl p-8 cursor-pointer hover:scale-105 transition-all duration-300">
